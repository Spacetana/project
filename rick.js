...
client.on('message',  async message => {
  ...
  if (msg.content === prefix + 'help' || msg.content === prefix + 'h') {
    ...
    .addField(`\`${PREFIX}help mod\``,      "Permet d'accéder à la page d'aide des commandes mod")
    .addField(`\`${PREFIX}help fun\``,      "Permet d'accéder à la page d'aide des commandes fun")
	  .addField(`\`${PREFIX}help info\``,     "Permet d'accéder à la page d'aide des commandes info")
    .addField(`\`${PREFIX}help love\``,     "Permet d'accéder à la page d'aide des commandes love")
    // .addField(`\`${PREFIX}help nsfw\``,     "Permet d'accéder à la page d'aide des commandes nsfw🔞")
    .addField(`\`${PREFIX}help hentai\``,   "Permet d'accéder à la page d'aide des commandes hentai🔞")

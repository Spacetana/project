...
client.on('message',  async message => {
  ...
  if (msg.content === prefix + 'help nsfw' || msg.content === prefix + 'h nsfw') {
    ...
    .addField(`\`${PREFIX}ass\``,      "Permet d'afficher une image pornographique de cul")
    .addField(`\`${PREFIX}anal\``,     "Permet d'afficher un gif pornographique d'acte anal")
    .addField(`\`${PREFIX}suck\``,     "Permet d'afficher un gif pornographique d'acte de suçage")
    .addField(`\`${PREFIX}pussy\``,    "Permet d'afficher une image pornographique avec des vagins")

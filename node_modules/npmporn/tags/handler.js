...
/**
 * @arg {String} source Image pull methods
 * @arg {String} site Request endpoint
 */
            ...
            switch (source) {
                ...
                case "other":
                    ...
                    if (!regex) reject({
                        ...
                        message: "Couldn't do request because there wasn't a regular expression supplied"
                    });
